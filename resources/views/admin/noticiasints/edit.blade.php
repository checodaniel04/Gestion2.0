...
@endif
    {!! Form::model($noticiasint,['route' =>  ['admin.noticiasints.update', $noticiasint],'files'=>true, 'method'=>'put']) !!}
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <div class="image-wrapper">
                <img id="picture" src="{{Storage::url($noticiasint->url)}}" alt="">
            </div>
            @else
            <div class="image-wrapper">
    ...
    <div class="form-group">
        ...
        {!! Form::textarea('noticia', null, ['class'=>'form-control', 'placeholder'=>'Ingrese la noticia']) !!}
        @error('noticia')
        <span class="text-danger">{{$message}}</span>
    @enderror
    </div>
